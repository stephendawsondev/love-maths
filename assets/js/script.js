...
/**
 * The main game "loop", called when
 * the script is first loaded and the
...
/** 
 * Checks the answer against the first
...
/**
 * Gets the operands (the numbers) and
 * the operator (plus, minus, etc.) directly
